...
const Profile = () => {
    return (
        <div className='w-full my-4 md:my-4 lg:my-0 relative mb-[260px] md:mb-[260px]'>
            ...
            <div style={{ borderRadius: "50% 50% 100% 0% / 20% 20% 0% 20%" }} className=' absolute w-full bottom-[-230px] z-40 right-0 border bg-white'>
                <div className=' flex flex-col items-center my-3'>
                    <div className='h-[80px] w-[150px]'></div>
                </div>
                <div>
                    <Image priority={true} className='rounded-full border-2 border-white z-40 shadow-2xl absolute top-[-60px] m-auto left-0 right-0 h-[150px] w-[150px] ' width={300} height={300} src='https://res.cloudinary.com/depy0i4bl/image/upload/v1741533508/New_Project_2_nocpmp.jpg' alt='' />
                    ...
                    <div className='flex justify-between mt-5 items-center shadow-xl'>
                        ...
                        <Link href='/#contact' className='w-full'><button type="button" className='w-full flex items-center justify-between text-lg font-medium border px-3 py-4'>Contact Me <FaLocationArrow size={16} /></button></Link>
                    </div>
                </div>
            </div>
        </div>
