  ...
  return (
    <div className=" bg-[#F6F6F6] px-5 py-10 mx-auto min-h-screen max-w-7xl flex-grow">
      <div className='flex justify-between'>
        <Navbar />
        <div className='w-5/12 h-screen sticky top-0 overflow-hidden'>
          <div className='w-full relative'>
            ...
            <div style={{ borderRadius: "50% 50% 100% 0% / 20% 20% 0% 20%" }} className=' absolute w-full bottom-[-230px] z-50 right-0 border bg-white'>
        ...
        <div className='w-6/12 overflow-y-auto h-screen'>
          {children}
        </div>
      </div>
    </div>
